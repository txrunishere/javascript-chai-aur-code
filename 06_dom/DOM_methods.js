...
// Here, to get the inside div element we first use div id and then access inside elements

// const btnElement = document.querySelector('#wrapper button');
// const inpElement = document.querySelector('#wrapper input');